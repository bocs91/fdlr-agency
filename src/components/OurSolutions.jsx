        ...
        >
          <div className="bg-white border rounded-lg shadow-lg p-6 w-full">
                ...
                <div className="h-10 w-10 bg-white flex items-center justify-center rounded-md">
                  <img
                    src={
                      ...
                      icons[`../assets/icons/${currentSolution.icon}`]
                    }
            ...
            <section aria-labelledby={`points-title-${currentSolution.id}`}>
              <h3
                id={`points-title-${currentSolution.id}`}
                className="sr-only"
              >
                Points clés
              </h3>
            ...
            {/* Avantages */}
            <section
              aria-labelledby={`advantages-title-${currentSolution.id}`}
            >
              <h3
            ...
            <section
              aria-labelledby={`tools-title-${currentSolution.id}`}
            >
              <h3
